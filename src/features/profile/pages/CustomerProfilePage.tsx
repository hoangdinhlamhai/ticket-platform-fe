      ...
      <div className="attendee-container">
        <header className="mb-8 flex flex-wrap items-center justify-between gap-5 rounded-lg border border-line bg-paper p-6 mobile:p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="m-0 text-[0.7rem] font-extrabold tracking-[0.11em] text-coral-dark">HỒ SƠ KHÁCH HÀNG</p>
          ...
          <span className="rounded-sm border border-blue/40 bg-google-hover px-3 py-2 text-[0.7rem] font-extrabold tracking-[0.08em] text-blue-deep">DỮ LIỆU MINH HỌA</span>
        </header>
