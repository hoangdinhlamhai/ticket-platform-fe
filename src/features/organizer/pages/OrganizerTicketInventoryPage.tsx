...
type Props = {
  ...
  onSaveTicketTier: (tier: OrganizerTicketTier) => void
  onSetSaleStatus: (tierId: string, status: OrganizerTicketTier['saleStatus']) => void
  workspace: OrganizerWorkspace
}

export function OrganizerTicketInventoryPage({ activeRoute, eventId, onNavigate, onSaveTicketTier, onSetSaleStatus, workspace }: Props) {
